...
vim.keymap.set("n", "<leader>fF", "<cmd>Pick document_symbols is:Function is:Constructor is:Method<cr>", { desc = "Document functions" })
...
vim.keymap.set("n", "<leader>fe", "<cmd>Pick quickfix type:E<cr>", { desc = "Quickfix errors" })
