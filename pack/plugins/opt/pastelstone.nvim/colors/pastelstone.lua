...
_hl('GitGutterAdd',            { fg = _c.lime,     bg = _c.bg })
_hl('GitGutterChange',         { fg = _c.amber,    bg = _c.bg })
_hl('GitGutterDelete',         { fg = _c.red,      bg = _c.bg })
_hl('GitGutterChangeDelete',   { fg = _c.mauve,    bg = _c.bg })
...
-- ── Diffview ──────────────────────────────────────────────────────
_hl('DiffviewNormal',              { fg = _c.fg,       bg = _c.bg })
_hl('DiffviewCursorLine',          { bg = _c.bg_cursor })
_hl('DiffviewSignColumn',          { fg = _c.subtle,   bg = _c.bg })
_hl('DiffviewEndOfBuffer',         { fg = _c.muted })
_hl('DiffviewLineNr',              { fg = _c.subtle })
_hl('DiffviewWinSeparator',        { fg = _c.overlay })
_hl('DiffviewFilePanelTitle',      { fg = _c.fg_alt,   gui = 'bold' })
_hl('DiffviewFilePanelCounter',    { fg = _c.subtle })
_hl('DiffviewFilePanelFileName',   { fg = _c.fg_alt })
_hl('DiffviewFilePanelPath',       { fg = _c.subtle })
_hl('DiffviewFilePanelRootPath',   { fg = _c.fg_alt,   gui = 'bold' })
_hl('DiffviewFilePanelInsertions', { fg = _c.lime,     gui = 'bold' })
_hl('DiffviewFilePanelDeletions',  { fg = _c.red,      gui = 'bold' })
_hl('DiffviewStatusAdded',         { fg = _c.lime,     gui = 'bold' })
_hl('DiffviewStatusUntracked',     { fg = _c.lime })
_hl('DiffviewStatusModified',      { fg = _c.amber,    gui = 'bold' })
_hl('DiffviewStatusRenamed',       { fg = _c.sky,      gui = 'bold' })
_hl('DiffviewStatusCopied',        { fg = _c.sky })
_hl('DiffviewStatusTypeChange',    { fg = _c.mauve,    gui = 'bold' })
_hl('DiffviewStatusDeleted',       { fg = _c.red,      gui = 'bold' })
_hl('DiffviewStatusBroken',        { fg = _c.flame,    gui = 'bold' })
_hl('DiffviewStatusUnknown',       { fg = _c.red })
_hl('DiffviewStatusUnmerged',      { fg = _c.lavender, gui = 'bold' })
_hl('DiffviewDiffAddAsDelete',     { fg = _c.flame,    bg = _c.bg_red })
_hl('DiffviewDiffDelete',          { fg = _c.muted,    bg = _c.bg })
